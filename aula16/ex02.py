...
print(f"Idade media das Mulheres: {idade_media_f:.2f}")
print(f"Idade media dos Homens: {idade_media_m:.2f}")
print(f"Idade media geral é: {(total_idades / len(idades)):.2f}")
